      ...
      <div className="relative w-full max-w-lg bg-white border border-[#cacacb] rounded-none p-6 sm:p-8 z-10 text-[#111111] animate-in zoom-in-95 duration-150">
        ...
        <div className="my-4 p-4 border border-[#cacacb] bg-[#f5f5f5] flex items-center justify-between">
          <div>
            ...
            <div className="text-[11px] text-[#707072] flex items-center gap-1 mt-1">
              <Clock className="w-3 h-3 text-[#707072]" />
              <span>{formatDateTime(booking.start_time)} ({booking.duration_hours} hr)</span>
            </div>
          </div>
          <div className="text-right">
            <span className="text-[10px] text-[#707072] block font-bold uppercase">Total Paid</span>
            <span className="text-lg font-bold text-[#111111]">
              ₱{Number(booking.total_price).toFixed(2)}
            </span>
            <span className="text-[10px] text-[#707072] block uppercase">
        ...
        {hasWalletInfo ? (
          <div className="mb-4 p-4 border border-[#cacacb] bg-[#f5f5f5] space-y-3">
            <div className="flex items-center justify-between">
              ...
              <span className="px-2.5 py-0.5 rounded-full bg-white text-[#111111] text-xs font-bold border border-[#cacacb]">
                {booking.refund_wallet_type || "GCash"}
              </span>
            </div>

            <div className="grid grid-cols-2 gap-3 text-xs">
              <div className="p-2.5 bg-white border border-[#cacacb]">
                <span className="text-[10px] text-[#707072] block font-bold uppercase">Account Name</span>
                <div className="flex items-center justify-between mt-0.5">
                  ...
                  <button
                    ...
                    className="text-[#707072] hover:text-[#111111] p-1"
                    title="Copy name"
                  >
              ...
              <div className="p-2.5 bg-white border border-[#cacacb]">
                <span className="text-[10px] text-[#707072] block font-bold uppercase">Account / Mobile No.</span>
                <div className="flex items-center justify-between mt-0.5">
                  <span className="font-mono font-bold text-[#111111] truncate">
            ...
            {booking.refund_reason && (
              <div className="text-xs text-[#707072] pt-1">
                <span className="text-[10px] font-bold uppercase block text-[#111111]">Player Reason:</span>
                <p className="italic bg-white p-2 border border-[#cacacb] mt-1">
          ...
          <div className="mb-4 p-3 border border-[#cacacb] bg-[#f5f5f5] text-xs text-[#707072]">
        ...
        <div className="space-y-3.5 mb-6">
          <div className="space-y-1.5">
            <Label htmlFor="refundRef" className="text-xs font-bold uppercase tracking-wider text-[#111111]">
          ...
          <div className="space-y-1.5">
            <Label htmlFor="adminNotes" className="text-xs font-bold uppercase tracking-wider text-[#111111]">
        ...
        <div className="space-y-2.5">
          <Button
            ...
            className="w-full h-11 bg-[#111111] text-white hover:bg-[#222222] font-medium text-xs flex items-center justify-center gap-2 rounded-full"
          >
            {isPending ? (
          ...
          <div className="grid grid-cols-2 gap-2">
            ...
            {booking.status === 'cancelled_refund_pending' && (
              <Button
                ...
                className="h-10 border-[#cacacb] text-[#d30005] hover:bg-[#f5f5f5] text-xs font-medium"
              >
                Reject Refund
              </Button>
            )}
